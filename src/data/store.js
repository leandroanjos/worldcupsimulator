const Store = {
	...
	matches: [
		{ code: 1, teams: [ 1, 2 ], result: [ 0, 0 ] },
		{ code: 2, teams: [ 3, 4 ], result: [ 0, 0 ] },
		{ code: 3, teams: [ 5, 6 ], result: [ 0, 0 ] },
		{ code: 4, teams: [ 7, 8 ], result: [ 0, 0 ] },
		{ code: 5, teams: [ 9, 10 ], result: [ 0, 0 ] },
		{ code: 6, teams: [ 11, 12 ], result: [ 0, 0 ] },
		{ code: 7, teams: [ 13, 14 ], result: [ 0, 0 ] },
		{ code: 8, teams: [ 15, 16 ], result: [ 0, 0 ] },
		{ code: 9, teams: [ 17, 18 ], result: [ 0, 0 ] },
		{ code: 10, teams: [ 19, 20 ], result: [ 0, 0 ] },
		{ code: 11, teams: [ 21, 22 ], result: [ 0, 0 ] },
		{ code: 12, teams: [ 23, 24 ], result: [ 0, 0 ] },
		{ code: 13, teams: [ 25, 26 ], result: [ 0, 0 ] },
		{ code: 14, teams: [ 27, 28 ], result: [ 0, 0 ] },
		{ code: 15, teams: [ 29, 30 ], result: [ 0, 0 ] },
		{ code: 16, teams: [ 31, 32 ], result: [ 0, 0 ] },
		{ code: 17, teams: [ 1, 3 ], result: [ 0, 0 ] },
		{ code: 18, teams: [ 4, 2 ], result: [ 0, 0 ] },
		{ code: 19, teams: [ 5, 7 ], result: [ 0, 0 ] },
		{ code: 20, teams: [ 8, 6 ], result: [ 0, 0 ] },
		{ code: 21, teams: [ 9, 11 ], result: [ 0, 0 ] },
		{ code: 22, teams: [ 12, 10 ], result: [ 0, 0 ] },
		{ code: 23, teams: [ 13, 15 ], result: [ 0, 0 ] },
		{ code: 24, teams: [ 16, 14 ], result: [ 0, 0 ] },
		{ code: 25, teams: [ 17, 19 ], result: [ 0, 0 ] },
		{ code: 26, teams: [ 20, 18 ], result: [ 0, 0 ] },
		{ code: 27, teams: [ 21, 23 ], result: [ 0, 0 ] },
		{ code: 28, teams: [ 24, 22 ], result: [ 0, 0 ] },
		{ code: 29, teams: [ 25, 27 ], result: [ 0, 0 ] },
		{ code: 30, teams: [ 28, 26 ], result: [ 0, 0 ] },
		{ code: 31, teams: [ 29, 31 ], result: [ 0, 0 ] },
		{ code: 32, teams: [ 32, 30 ], result: [ 0, 0 ] },
		{ code: 33, teams: [ 4, 1 ], result: [ 0, 0 ] },
		{ code: 34, teams: [ 2, 3 ], result: [ 0, 0 ] },
		{ code: 35, teams: [ 8, 5 ], result: [ 0, 0 ] },
		{ code: 36, teams: [ 6, 7 ], result: [ 0, 0 ] },
		{ code: 37, teams: [ 12, 9 ], result: [ 0, 0 ] },
		{ code: 38, teams: [ 10, 11 ], result: [ 0, 0 ] },
		{ code: 39, teams: [ 16, 13 ], result: [ 0, 0 ] },
		{ code: 40, teams: [ 14, 15 ], result: [ 0, 0 ] },
		{ code: 41, teams: [ 20, 17 ], result: [ 0, 0 ] },
		{ code: 42, teams: [ 18, 19 ], result: [ 0, 0 ] },
		{ code: 43, teams: [ 24, 21 ], result: [ 0, 0 ] },
		{ code: 44, teams: [ 22, 23 ], result: [ 0, 0 ] },
		{ code: 45, teams: [ 28, 25 ], result: [ 0, 0 ] },
		{ code: 46, teams: [ 26, 27 ], result: [ 0, 0 ] },
		{ code: 47, teams: [ 32, 29 ], result: [ 0, 0 ] },
		{ code: 48, teams: [ 30, 31 ], result: [ 0, 0 ] }
	]
}
